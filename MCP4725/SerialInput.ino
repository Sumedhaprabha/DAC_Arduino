/*Code to get the correct input from the Serial monitor*/
// void loop(void){
//   if(Serial.available())
//   {
...
//why is voltage going to 0.0 after every loop? - its because if the timeout is more than a second the serial monitor will assume the value 0 
//Solution - Use newline or atoi
